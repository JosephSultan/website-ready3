export default function Features() {
  return (
    <section
      id="features"
      className="py-10 bg-gradient-to-t from-[#524790] to-[#8c79ed]"
    >
          ...
          <div className="grid grid-cols-1 grid-rows-2 gap-8 text-lg md:grid-cols-2 lg:grid-cols-3">
            <div className="flex shadow-md hover:shadow-[#00e4ff] flex-col justify-between p-5 transition duration-400 bg-white bg-opacity-20 rounded-xl card-hover group space-y-5">
              ...
              <p className="text-gray-200">
                We help you to choose the right support platform for your needs and budget and fully implement it for your team with ease!
            ...
            <div className="flex shadow-md hover:shadow-[#00e4ff] flex-col justify-between p-5 transition duration-400 bg-white bg-opacity-20 rounded-xl card-hover group space-y-5">
              ...
              <h3 className="text-xl font-semibold text-white">
              CX Operations systems and metrics building
              </h3>
              <p className="text-gray-200">
              We help you build your internal CX Operational system, KPIs, MOSes and OKRs
            ...
            <div className="flex shadow-md hover:shadow-[#00e4ff] flex-col justify-between p-5 transition duration-400 bg-white bg-opacity-20 rounded-xl card-hover group space-y-5">
              ...
              <p className="text-gray-200">
              Your contact rate is growing? We got you covered!
We help scale your internal processes and operations to keep up with the scale at ease
